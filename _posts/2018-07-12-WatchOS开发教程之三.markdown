...
在 WatchOS中`WKInterfaceController`就相当于 iOS中的 `UIVIewController`, 同样具有类似生命周期和方法。 这里就不再赘述了, 想了解请查看第一篇文章:[Watch App架构及生命周期](https://blog.csdn.net/wangyanchang21/article/details/80928126)。
